...
class VisualizationDemo(object):
    def __init__(self, cfg, output_path, instance_mode=ColorMode.IMAGE, parallel=False):
        ...
        self.output_dirs = {
            ...
            # 'binary_masks': os.path.join(output_path, "binary_masks")  # 注释掉二值化掩码目录
        }
    ...
    def run_on_image(self, image, image_name):
        ...
        */
        ...
        if "panoptic_seg" in predictions:
            ...
            # print(f"- 二值化掩码：{self.output_dirs['binary_masks']}/binary_{output_name}")  # 注释掉
